...
export default function Layout({ children }) {
  ...
  const { language, changeLanguage, t, isOpen: languageMenuOpen, setIsOpen: setLanguageMenuOpen, availableLanguages } = useLanguage()
  ...
  useEffect(() => {
    if (router.pathname === '/settings' || router.pathname === '/team') {
      ...
      <div className="relative language-selector-sidebar">
        ...
        >
          <div className="flex items-center">
            ...
            <span>{availableLanguages?.find(l => l.code === language)?.name || 'Nederlands'}</span>
          </div>
